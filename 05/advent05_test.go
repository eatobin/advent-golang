...
func TestOpCode(t *testing.T) {
	test01In := intcode.MakeMemory("resources05/test01In.csv")
	test01Out := intcode.MakeMemory("resources05/test01Out.csv")
	fixtures := []Fixtures{
		// in - out
		{intcode.IntCode{Input: 198, Output: 0, Pointer: 0, Memory: test01In},
			intcode.IntCode{Input: 198, Output: 198, Pointer: 4, Memory: test01Out}},
		//// 99 to end
